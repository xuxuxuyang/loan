...
<template>
  ...
  >
                ...
                <div class="flex flex-wrap items-center justify-between gap-2 text-xs text-black/45">
                  ...
                  <div class="flex max-w-[min(100%,11rem)] shrink-0 flex-wrap items-center justify-end gap-1.5">
                    <button
                      ...
                      type="button"
                      class="wv-gradient-bill rounded-full px-2.5 py-1 text-[11px] font-semibold shadow-sm transition hover:brightness-105 active:opacity-90 disabled:opacity-50"
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        ...
                        type="button"
                        class="wv-gradient-danger mt-2 w-full rounded-lg py-2.5 text-[12px] font-semibold shadow-sm transition hover:brightness-105 active:opacity-90 disabled:opacity-50"
                        :disabled="repayingAll || repayingBillKey !== null || negotiatedPayBillKey !== null"
    ...
    >
      ...
      <button
        type="button"
        class="wv-gradient-bill bill-submit w-full rounded-full py-3.5 text-base font-semibold transition hover:brightness-105 active:opacity-90 disabled:opacity-55"
