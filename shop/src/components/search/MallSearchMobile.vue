            ...
            <div class="min-w-0 flex-1">
              <div class="mb-1 flex flex-wrap items-center gap-1.5">
                ...
                <span
                  ...
                  class="shrink-0 rounded bg-gradient-to-r from-[#ff7b87] to-[#f06b81] px-1.5 py-0.5 text-[10px] font-medium text-white"
                >先享后付</span>
                <span
                  v-else
                  class="shrink-0 rounded bg-gradient-to-r from-[#ff8a5b] to-[#ff5f6b] px-1.5 py-0.5 text-[10px] font-medium text-white"
                >商城</span>
              </div>
