          ...
          >
            ...
            >
              ...
              <el-menu-item
                v-else
                :index="item.path"
                :class="{ 'admin-menu-item--cs-alert': item.path === '/cs-messages' && csMenuHasUnread }"
              >
                <el-icon class="admin-menu-icon">
                  <component :is="item.icon" />
                </el-icon>
                <span class="admin-menu-top-label">
                  <span class="admin-menu-top-label-text">{{ item.label }}</span>
                </span>
                <span
                  v-if="item.path === '/cs-messages' && csMenuHasUnread"
                  class="admin-cs-unread-float-badge"
                >有新消息</span>
              </el-menu-item>
            </template>
          </el-menu>
...
.admin-side-menu :deep(.el-menu-item.admin-menu-item--cs-alert) {
  position: relative;
  overflow: visible;
}
